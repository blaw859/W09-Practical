...
public class W09Practical {
    ...
    public static void main(String[] args) {
        ...
        initializeCache();
        try {
            System.out.println(XMLReader.readXML(formatQueryURL(),argumentMap.get("--search")));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private static void validateArgs() {
        ...
        } else if (!(argumentMap.get("--search").equals("author") || argumentMap.get("--search").equals("venue") || argumentMap.get("--search").equals("publication"))) {
